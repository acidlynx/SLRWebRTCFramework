...
RTC_OBJC_EXPORT
@protocol SLRRTCAudioSessionDelegate <NSObject>
...
- (void)audioSession:(SLRRTCAudioSession *)session didChangeCanPlayOrRecord:(BOOL)canPlayOrRecord;
...
- (void)audioSession:(SLRRTCAudioSession *)audioSession didChangeOutputVolume:(float)outputVolume;
 ...
 */
- (void)audioSession:(SLRRTCAudioSession *)audioSession willSetActive:(BOOL)active;

/** Called after the audio session sucessfully changed the active state.
 */
- (void)audioSession:(SLRRTCAudioSession *)audioSession didSetActive:(BOOL)active;
...
/** This is a protocol used to inform SLRRTCAudioSession when the audio session
 *  activation state has changed outside of SLRRTCAudioSession. The current known use
 *  case of this is when CallKit activates the audio session for the application
 */
RTC_OBJC_EXPORT
@protocol SLRRTCAudioSessionActivationDelegate <NSObject>
 ...
 *
 *  SLRRTCAudioSession also coordinates activation so that the audio session is
 *  activated only once. See |setActive:error:|.
 */
RTC_OBJC_EXPORT
@interface SLRRTCAudioSession : NSObject <SLRRTCAudioSessionActivationDelegate>
...
/** Whether SLRRTCAudioSession is currently locked for configuration. */
...
@interface SLRRTCAudioSession (Configuration)
 ...
 */
- (BOOL)setConfiguration:(SLRRTCAudioSessionConfiguration *)configuration error:(NSError **)outError;
