...
RTC_OBJC_EXPORT
// Camera capture that implements SLRRTCVideoCapturer. Delivers frames to a SLRRTCVideoCapturerDelegate
// (usually SLRRTCVideoSource).
NS_EXTENSION_UNAVAILABLE_IOS("Camera not available in app extensions.")
@interface SLRRTCCameraVideoCapturer : SLRRTCVideoCapturer
