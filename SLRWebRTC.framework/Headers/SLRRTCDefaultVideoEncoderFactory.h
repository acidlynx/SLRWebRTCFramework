...
#import "SLRRTCVideoEncoderFactory.h"
 ...
 */
RTC_OBJC_EXPORT
@interface SLRRTCDefaultVideoEncoderFactory : NSObject <SLRRTCVideoEncoderFactory>

@property(nonatomic, retain) SLRRTCVideoCodecInfo *preferredCodec;
