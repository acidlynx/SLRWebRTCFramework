 ...
 */
RTC_OBJC_EXPORT
@interface SLRRTCDispatcher : NSObject
 ...
 */
+ (void)dispatchAsyncOnType:(SLRRTCDispatcherQueueType)dispatchType block:(dispatch_block_t)block;
