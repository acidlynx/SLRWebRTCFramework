...
RTC_OBJC_EXPORT
@protocol SLRRTCDtmfSender <NSObject>

/**
 * Returns true if this SLRRTCDtmfSender is capable of sending DTMF. Otherwise
 * returns false. To be able to send DTMF, the associated SLRRTCRtpSender must be
