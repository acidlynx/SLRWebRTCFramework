...
typedef NS_ENUM(NSUInteger, SLRRTCFileLoggerSeverity) {
  SLRRTCFileLoggerSeverityVerbose,
  SLRRTCFileLoggerSeverityInfo,
  SLRRTCFileLoggerSeverityWarning,
  SLRRTCFileLoggerSeverityError
};

typedef NS_ENUM(NSUInteger, SLRRTCFileLoggerRotationType) {
  SLRRTCFileLoggerTypeCall,
  SLRRTCFileLoggerTypeApp,
};
...
RTC_OBJC_EXPORT
@interface SLRRTCFileLogger : NSObject

// The severity level to capture. The default is kRTCFileLoggerSeverityInfo.
@property(nonatomic, assign) SLRRTCFileLoggerSeverity severity;

// The rotation type for this file logger. The default is
// kRTCFileLoggerTypeCall.
@property(nonatomic, readonly) SLRRTCFileLoggerRotationType rotationType;
...
- (instancetype)initWithDirPath:(NSString *)dirPath
                   ...
                   rotationType:(SLRRTCFileLoggerRotationType)rotationType NS_DESIGNATED_INITIALIZER;
