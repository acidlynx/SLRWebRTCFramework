 ...
 * Error passing block.
 */
typedef void (^SLRRTCFileVideoCapturerErrorBlock)(NSError *error);

/**
 * Captures buffers from bundled video file.
 *
 * See @c SLRRTCVideoCapturer for more info on capturers.
 */
RTC_OBJC_EXPORT

NS_CLASS_AVAILABLE_IOS(10)
@interface SLRRTCFileVideoCapturer : SLRRTCVideoCapturer
...
- (void)startCapturingFromFileNamed:(NSString *)nameOfFile
                            onError:(__nullable SLRRTCFileVideoCapturerErrorBlock)errorBlock;
