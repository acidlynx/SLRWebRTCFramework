...
typedef NS_ENUM(NSUInteger, SLRRTCTlsCertPolicy) {
  SLRRTCTlsCertPolicySecure,
  SLRRTCTlsCertPolicyInsecureNoCheck
};

NS_ASSUME_NONNULL_BEGIN

RTC_OBJC_EXPORT
@interface SLRRTCIceServer : NSObject

/** URI(s) for this server represented as NSStrings. */
@property(nonatomic, readonly) NSArray<NSString *> *urlStrings;

/** Username to use if this SLRRTCIceServer object is a TURN server. */
@property(nonatomic, readonly, nullable) NSString *username;

/** Credential to use if this SLRRTCIceServer object is a TURN server. */
@property(nonatomic, readonly, nullable) NSString *credential;

/**
 * TLS certificate policy to use if this SLRRTCIceServer object is a TURN server.
 */
@property(nonatomic, readonly) SLRRTCTlsCertPolicy tlsCertPolicy;
...
/**
 * Initialize an SLRRTCIceServer with its associated URLs, optional username,
