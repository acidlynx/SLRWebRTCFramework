 ...
 */
typedef NS_ENUM(NSInteger, SLRRTCMediaStreamTrackState) {
  SLRRTCMediaStreamTrackStateLive,
  SLRRTCMediaStreamTrackStateEnded
};
...
RTC_OBJC_EXPORT
@interface SLRRTCMediaStreamTrack : NSObject
...
@property(nonatomic, readonly) SLRRTCMediaStreamTrackState readyState;
